    ...
    public class DatabaseInitializer
    {
        ...
        public static void InitializeDatabase(EntityContext entityContext)
        {
            ...
            var owners = new List<CarOwner>
            {
                ...
                cars.Add(new Car { Color = "Red", DateBought = Convert.ToDateTime("2017-04-08"), LicensePlate = "1-HSY-688", CarOwner = owners[4], CarType = cartypes[3] });
                ...
                cars.Add(new Car { Color = "White", DateBought = Convert.ToDateTime("2015-07-17"), LicensePlate = "1-KIP-069", CarOwner = owners[5], CarType = cartypes[7] });
                cars.Add(new Car { Color = "Blue", DateBought = Convert.ToDateTime("2016-11-02"), LicensePlate = "1-HOH-541", CarOwner = owners[0], CarType = cartypes[6] });
                cars.Add(new Car { Color = "Black", DateBought = Convert.ToDateTime("2010-06-24"), LicensePlate = "1-PIS-561", CarOwner = owners[5], CarType = cartypes[6] });
